...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	СписокВыбора.Добавить("СопоставленныеОбъектыПоРегистру",     "Сопоставленные объекты (не жестко)");
	СписокВыбора.Добавить("СопоставленныеОбъектыПоСсылке",       "Сопоставленные объекты (жестко)");
...
Процедура ОтменитьСопоставлениеДанных(ТекущиеДанные, ЭтоНеутверженнаяСвязь)
	...
	ЗаполнитьЗначенияСвойств(НоваяСтрокаИсточника, ТекущиеДанные, "ИсточникПоле1, ИсточникПоле2, ИсточникПоле3, ИсточникПоле4, ИсточникПоле5, УникальныйИдентификаторИсточника, ТипИсточника");
	ЗаполнитьЗначенияСвойств(НоваяСтрокаПриемника, ТекущиеДанные, "ПриемникПоле1, ПриемникПоле2, ПриемникПоле3, ПриемникПоле4, ПриемникПоле5, УникальныйИдентификаторПриемника, ТипПриемника");
...
Процедура ВыполнитьЗагрузкуДанныхНаСервере(Отказ)
	...
	ТаблицыДляЗагрузки.Добавить(Объект.ИмяТипаОбъектаТаблицыИсточника);
...
Функция ПолучитьАдресВременногоХранилищаТаблицыВыбораСвязи(ПараметрыОтбора)
	...
	Колонки = "НомерПоПорядку, ПолеСортировки1, ПолеСортировки2, ПолеСортировки3, ПолеСортировки4, ПолеСортировки5";
...
Процедура ПриЗакрытии()
	...
	// передаем дайджест сопоставления в форму помощника
	ПараметрыОповещения.Вставить("КоличествоОбъектовВИсточнике",       КоличествоОбъектовВИсточнике);
	ПараметрыОповещения.Вставить("КоличествоОбъектовВПриемнике",       КоличествоОбъектовВПриемнике);
	ПараметрыОповещения.Вставить("КоличествоОбъектовСопоставленных",   КоличествоОбъектовСопоставленных);
	ПараметрыОповещения.Вставить("КоличествоОбъектовНесопоставленных", КоличествоОбъектовНесопоставленных);
	ПараметрыОповещения.Вставить("ПроцентСопоставленияОбъектов",       ПроцентСопоставленияОбъектов);
	ПараметрыОповещения.Вставить("ИндексКартинки",                     ИндексКартинки);
...
Процедура ВыполнитьЗагрузкуДанных(Команда)
	...
	// выполняем оповещение формы помощника сопоставления об успешной загрузке данных
	ПараметрыОповещения = Новый Структура;
	ПараметрыОповещения.Вставить("КлючУникальности",       КлючУникальности);
	ПараметрыОповещения.Вставить("ДанныеУспешноЗагружены", Объект.ДанныеУспешноЗагружены);
	ПараметрыОповещения.Вставить("ИндексКартинки",         ИндексКартинки);
	
	Оповестить("ИнформацияЗагрузкиДанных", ПараметрыОповещения);
...
Процедура УстановитьОтборТабличныхЧастей()
	...
	ИначеЕсли ОтборПоСтатусуСопоставления = "СопоставленныеОбъектыПоРегистру"     Тогда ФиксированнаяСтруктура = Новый ФиксированнаяСтруктура("СтатусСопоставления",  0);
	ИначеЕсли ОтборПоСтатусуСопоставления = "СопоставленныеОбъектыПоСсылке"       Тогда ФиксированнаяСтруктура = Новый ФиксированнаяСтруктура("СтатусСопоставления",  2);
...
Процедура ДобавитьНеутвержденноеСопоставлениеНаКлиенте(ИдентификаторСтрокиНачала, ИдентификаторСтрокиОкончания)
	...
	ЗаполнитьЗначенияСвойств(НоваяСтрокаНеутвержденные, СтрокаИсточника, "ИсточникПоле1, ИсточникПоле2, ИсточникПоле3, ИсточникПоле4, ИсточникПоле5, УникальныйИдентификаторИсточника, ТипИсточника");
	ЗаполнитьЗначенияСвойств(НоваяСтрокаНеутвержденные, СтрокаПриемника, "ПриемникПоле1, ПриемникПоле2, ПриемникПоле3, ПриемникПоле4, ПриемникПоле5, УникальныйИдентификаторПриемника, ТипПриемника, ПолеСортировки1, ПолеСортировки2, ПолеСортировки3, ПолеСортировки4, ПолеСортировки5");
