...
Процедура УстановитьПараметрыРегламентногоЗадания(РегламентноеЗаданиеОбъект, РасписаниеРегламентногоЗадания, ТекущийОбъект)
	...
	НаименованиеРегламентногоЗадания = НСтр("ru = 'Выполнение обмена по настройке: [Наименование]'");
	НаименованиеРегламентногоЗадания = СтрЗаменить(НаименованиеРегламентногоЗадания, "[Наименование]", СокрЛП(ТекущийОбъект.Наименование));
...
Процедура ЗаписатьРегламентноеЗадание(Отказ, РегламентноеЗаданиеОбъект)
	...
	Исключение
		...
		СтрокаСообщения = НСтр("ru = 'Произошла ошибка при сохранении расписания выполнения обменов.
