	...
	Пока ЧтениеXML.Прочитать() Цикл
			...
			ИначеЕсли УровеньЧтения = 4 Тогда // указатель на поле табличной части
				...
				Если ЧтениеXML.КоличествоАтрибутов() > 0 Тогда
					Пока ЧтениеXML.ПрочитатьАтрибут() Цикл
						Если ЧтениеXML.ТипУзла = ТипУзлаXML.Атрибут 
						   И ЧтениеXML.Имя = "xsi:type" Тогда
							ТипЗначенияПоляТЧ = ЧтениеXML.Значение;
						КонецЕсли;
					КонецЦикла;
				КонецЕсли;
		...
		ИначеЕсли ЧтениеXML.ТипУзла = ТипУзлаXML.Текст Тогда
			...
			ИначеЕсли (УровеньЧтения = 4) Тогда // значение реквизита
				...
				ПоследняяСтрока[ИмяПоляТЧ] = ?(ПустаяСтрока(ТипЗначенияПоляТЧ), ЧтениеXML.Значение, XMLЗначение(Тип(ТипЗначенияПоляТЧ), ЧтениеXML.Значение));
